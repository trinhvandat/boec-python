"""
Django settings for ecommerBoEC project.
...
SECRET_KEY = 'django-insecure-hujp7kl$*iktmweg==u@esp30%s^*go%-yu1xl6%m2s6bnjz69'
...
WSGI_APPLICATION = 'ecommerBoEC.wsgi.application'
